...
public class After extends ActionBarActivity{
...
/** Called when the activity is first created. */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.after_interview);
    ...
    public void getData(){
    	...
    	try{
            ...
            HttpPost httppost = new HttpPost("http://testserver.co.ke/mobile/publicimage/json2/after_int.php");
