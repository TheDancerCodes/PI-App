...
public class During extends ActionBarActivity{
...
/** Called when the activity is first created. */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.during_interview);
    ...
    public void getData(){
    	...
    	try{
            ...
            HttpPost httppost = new HttpPost("http://testserver.co.ke/mobile/publicimage/json2/during_int.php");
