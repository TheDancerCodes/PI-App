...
public class Before extends ActionBarActivity {
...
/** Called when the activity is first created. */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.before_interview);
    ...
    public void getData(){
    	...
    	try{
            ...
            HttpPost httppost = new HttpPost("http://testserver.co.ke/mobile/publicimage/json2/before_int.php");
