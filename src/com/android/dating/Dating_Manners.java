...
public class Dating_Manners extends ActionBarActivity{
...
/** Called when the activity is first created. */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dating_manners);
    ...
    public void getData(){
    	...
    	try{
            ...
            HttpPost httppost = new HttpPost("http://testserver.co.ke/mobile/publicimage/json2/dressing.php");
