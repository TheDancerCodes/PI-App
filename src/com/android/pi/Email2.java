...
public class Email2 extends ActionBarActivity {
/** Called when the activity is first created. */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.office_etiquette);
    ...
    public void getData(){
    	...
    	try{
            ...
            //HttpPost httppost = new HttpPost("http://testserver.co.ke/mobile/publicimage/json2/ofisi.php");
           HttpPost httppost = new HttpPost("http://testserver.co.ke/mobile/publicimage/json2/email_etiquette.php");
