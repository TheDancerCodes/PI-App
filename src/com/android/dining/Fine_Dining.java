...
public class Fine_Dining extends ActionBarActivity{
...
/** Called when the activity is first created. */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fine_dining);
    ...
    public void getData(){
    	...
    	try{
            ...
            HttpPost httppost = new HttpPost("http://testserver.co.ke/mobile/publicimage/json2/fine_dining.php");
